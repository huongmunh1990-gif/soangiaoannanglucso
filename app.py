...
<div class="main-header">
    ...
    <p>Tác giả: Mùng Thị Hương - Trường PTDTBT Tiểu học Ngam La - ĐT: 036 3693 615</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mùng Thị Hương - Trường PTDTBT Tiểu học Ngam La - ĐT: 036 3693 615</div>", unsafe_allow_html=True)
